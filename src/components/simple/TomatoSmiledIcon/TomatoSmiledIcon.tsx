...
import { useBrandGreenModeValue, useBrandRedModeValue } from "../../../hooks";

export function TomatoSmiledIcon(props: HTMLChakraProps<"svg">) {
  const { boxSize = "110px" } = props;

  const red400 = useBrandRedModeValue(400);
  const red100 = useBrandRedModeValue(100);
  const green400 = useBrandGreenModeValue(400);
    ...
    >
      <g clipPath="url(#clip0_16_527)">
        ...
        <g filter="url(#filter0_f_16_527)">
          <circle cx="29.5" cy="75.5" r="5.5" fill={red100} />
        </g>
        <g filter="url(#filter1_f_16_527)">
          <circle cx="85.5" cy="75.5" r="5.5" fill={red100} />
        </g>
